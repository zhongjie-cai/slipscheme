...
func (s *SchemaProcessor) structComment(schema *Schema, typeName string) string {
	...
	return fmt.Sprintf("// %s defined from schema [%v]:\n// %s\n", typeName, schema.File, prettySchema)
}
...
func (s *SchemaProcessor) writeGoCode(typeName, code string) error {
	...
	preamble += fmt.Sprintf("//                                                                     //\n")
	preamble += fmt.Sprintf("// This Code is Generated by SlipScheme Project:                       //\n")
	preamble += fmt.Sprintf("// https://github.com/zhongjie-cai/slipscheme                          //\n")
	preamble += fmt.Sprintf("//                                                                     //\n")
	preamble += fmt.Sprintf("/////////////////////////////////////////////////////////////////////////\n")
	preamble += fmt.Sprintf("//                            DO NOT EDIT                              //\n")
	preamble += fmt.Sprintf("/////////////////////////////////////////////////////////////////////////\n")
	preamble += fmt.Sprintf("\n")
